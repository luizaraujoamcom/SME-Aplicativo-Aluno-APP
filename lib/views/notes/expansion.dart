...
class _ExpansionState extends State<Expansion> {
            ...
            : _listNotesController.listNotesTres != null &&
                ...
                : _listNotesController.listNotesQuatro != null &&
                    ...
                    ? _listNotesController
                        .listNotesQuatro[index].componenteCurricular
                    : _listNotesController
                        .listNotesFinal[index].componenteCurricular;
  }
  ...
  _buildNotesBimestreFinal(index) {
    return _listNotesController.listNotesFinal != null &&
            _listNotesController.listNotesFinal.isNotEmpty
        ? _listNotesController.listNotesFinal[index].nota
        : '-';
  }
  ...
  _buildNotesCorUm(index) {
    return _listNotesController.listNotesUm != null &&
            _listNotesController.listNotesUm.isNotEmpty
        ? HexColor(_listNotesController.listNotesUm[index].corNotaAluno)
        : Color(0xFFD4D4D4);
  }
  ...
  _buildNotesCorDois(index) {
    return _listNotesController.listNotesDois != null &&
            _listNotesController.listNotesDois.isNotEmpty
        ? HexColor(_listNotesController.listNotesDois[index].corNotaAluno)
        : Color(0xFFD4D4D4);
  }
  ...
  _buildNotesCorTres(index) {
    return _listNotesController.listNotesTres != null &&
            _listNotesController.listNotesTres.isNotEmpty
        ? HexColor(_listNotesController.listNotesTres[index].corNotaAluno)
        : Color(0xFFD4D4D4);
  }
  ...
  _buildNotesCorQuatro(index) {
    return _listNotesController.listNotesQuatro != null &&
            _listNotesController.listNotesQuatro.isNotEmpty
        ? HexColor(_listNotesController.listNotesQuatro[index].corNotaAluno)
        : Color(0xFFD4D4D4);
  }
  ...
  _buildNotesCorFinal(index) {
    return _listNotesController.listNotesFinal != null &&
            _listNotesController.listNotesFinal.isNotEmpty
        ? HexColor(_listNotesController.listNotesFinal[index].corNotaAluno)
        : Color(0xFFD4D4D4);
  }
  ...
  _buildNotesDescUm(index) {
    return _listNotesController.listNotesUm != null &&
            _listNotesController.listNotesUm.isNotEmpty
        ? _listNotesController.listNotesUm[index].notaDescricao
        : '';
  }
  ...
  _buildNotesDescDois(index) {
    return _listNotesController.listNotesDois != null &&
            _listNotesController.listNotesDois.isNotEmpty
        ? _listNotesController.listNotesDois[index].notaDescricao
        : '';
  }
  ...
  _buildNotesDescTres(index) {
    return _listNotesController.listNotesTres != null &&
            _listNotesController.listNotesTres.isNotEmpty
        ? _listNotesController.listNotesTres[index].notaDescricao
        : '';
  }
  ...
  _buildNotesDescQuatro(index) {
    return _listNotesController.listNotesQuatro != null &&
            _listNotesController.listNotesQuatro.isNotEmpty
        ? _listNotesController.listNotesQuatro[index].notaDescricao
        : '';
  }
  ...
  _buildNotesDescFinal(index) {
    return _listNotesController.listNotesFinal != null &&
            _listNotesController.listNotesFinal.isNotEmpty
        ? _listNotesController.listNotesFinal[index].notaDescricao
        : '';
  }
  ...
  _hasListNotes() =>
      (_listNotesController.listNotesUm != null &&
          _listNotesController.listNotesUm.isNotEmpty) ||
      (_listNotesController.listNotesDois != null &&
          _listNotesController.listNotesDois.isNotEmpty) ||
      (_listNotesController.listNotesTres != null &&
                ...
                child: Column(
                  children: [
                    _listNotesController.bFinal != null
                        ? ObsBody(
                            recomendacoesAluno: _listNotesController.bFinal !=
                                    null
                                ? _listNotesController.bFinal.recomendacoesAluno
                                : 'Sem recomendações ao aluno para este bimestre.',
                            recomendacoesFamilia: _listNotesController.bFinal !=
                                    null
                                ? _listNotesController
                                    .bFinal.recomendacoesFamilia
                                : 'Sem recomendações à familía para este bimestre',
                            current: _listNotesController.bFinal != null
                                ? true
                                : false,
                            title: 'Final',
                          )
                    ...
                    _listNotesController.bQuatro != null
                        ? ObsBody(
                            recomendacoesAluno: _listNotesController.bQuatro !=
                                    null
                                ? _listNotesController
                    ...
                    _listNotesController.bTres != null
                        ? ObsBody(
                            recomendacoesAluno: _listNotesController.bTres !=
                                    null
                                ? _listNotesController.bTres.recomendacoesAluno
                                : 'Sem recomendações ao aluno para este bimestre.',
                            recomendacoesFamilia: _listNotesController.bTres !=
                                    null
                                ? _listNotesController
                                    .bTres.recomendacoesFamilia
                                : 'Sem recomendações à familía para este bimestre',
                            current: _listNotesController.bQuatro == null &&
                                    _listNotesController.bTres != null
                                ? true
                                : false,
                            title: '3º Bim.',
                    ...
                    _listNotesController.bDois != null
                        ? ObsBody(
                            recomendacoesAluno: _listNotesController.bDois !=
                                    null
                                ? _listNotesController.bDois.recomendacoesAluno
                                : 'Sem recomendações ao aluno para este bimestre.',
                            recomendacoesFamilia: _listNotesController.bUm !=
                                    null
                                ? _listNotesController
                    ...
                    _listNotesController.bDois != null
                        ? ObsBody(
                            recomendacoesAluno: _listNotesController.bUm != null
                                ? _listNotesController.bUm.recomendacoesAluno
                                : 'Sem recomendações ao aluno para este bimestre.',
                            recomendacoesFamilia: _listNotesController.bUm !=
                                    null
                                ? _listNotesController.bUm.recomendacoesFamilia
                                : 'Sem recomendações à familía para este bimestre',
                            current: _listNotesController.bDois == null &&
